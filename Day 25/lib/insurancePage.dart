...
class InsurancePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      home: Scaffold( appBar: AppBar(leading: Icon(Icons.arrow_back), title: Text("Insurance page"), backgroundColor: AppColors.navyBlue, foregroundColor: AppColors.pureWhite),
